...
double chord_met(double x1, double x2, double epsilon, unsigned int iteration, unsigned int N);
double half_div_met(double x1, double x2, double epsilon, unsigned int iteration, unsigned int N);
...
int main()
{
    ...
    while(1)
    {
        ...
        {
        case 1:
            printf("Xi = %.10lf\n", chord_met(x1, x2, epsilon, need_iterations, N));
        break;
        case 2:
            printf("Xi = %.10lf\n", half_div_met(x1, x2, epsilon, need_iterations, N));
        break;
        }
        end=clock();
        time=(end - start);
...
double chord_met(double x1, double x2, double epsilon, unsigned int need_iterations, unsigned int N)
{
    double xi;
...
double half_div_met(double x1, double x2, double epsilon, unsigned int need_iterations, unsigned int N)
{
    double xi;
